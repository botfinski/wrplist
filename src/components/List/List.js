...
const list = props => {
  ...
  if (props.list.length) {
              ...
              {props.list
                ...
                .map((listItem, index) => {
                  return (
                    ...
                    >
                      <div className="List-Item-Name" onClick={() => props.itemClicked(listItem)}>
                        {listItem.title}
                      </div>

                      <div className="List-Item-Controls">
                        <Button name="Edit" className="List-Item-Edit" clicked={props.handleItemEditClicked} />
                        <Button name="Remove" className="List-Item-Remove" clicked={props.handleItemRemoveClicked} />
                      </div>
                    </li>
                  );
                })}
    ...
    return (
      <div className="List No-Results">
        <p>
          No results with phrase "<strong>{props.searchQuery}</strong>"
        </p>
      </div>
    );
  }
