...
const modal = props => (
  <div className={props.modalOpened ? "Modal visible" : "Modal"}>
    ...
    <div className="Modal-Content">
      ...
      <textarea maxLength="150" value={props.newItemTitle} onChange={props.handleNewItemTitle} />
      <p className="charsLeft">Characters left: {props.charsLeft - props.newItemTitle.length}</p>
    </div>

    <Controls>
      <Button name="Close" className="Cancel" clicked={props.closeClicked} />
      <Button name="Save" className="Save-Item" clicked={props.handleSaveItem} disabled={props.disabled} />
    </Controls>
  </div>
);
